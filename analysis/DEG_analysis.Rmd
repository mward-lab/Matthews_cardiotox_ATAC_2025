...
peakAnnoList_DOX_DAR <- lapply(all_DAR_regions_gr, annotatePeak, tssRegion =c(-2000,2000), TxDb=txdb)
 # saveRDS(peakAnnoList_DOX_DAR, "data/Final_four_data/re_analysis/DOX_DAR_annotated_peaks_chipannno.RDS")
...
```{r looking at proportion of DE genes that are DOX DAR}
...
NOw to make a dataframe for RNA marked DEGs and TSS
#### 3 hour DAR and DEGs
...
three_hour_df %>% 
  ...
  geom_bar(position="fill")+
  theme_bw()+
  ggtitle(" DOX DARs with DEGs at 3 hours within 2kb")+
  ylab("proportion")
...
three_hour_df %>% 
 ...
 ggplot(., aes(x=sig_val,fill=DEG))+
  geom_bar(position="fill")+
  theme_bw()+
  ggtitle(" DOX DARs with DEGs at 3 hours within 20kb")+
  ylab("proportion")
...
three_hour_df %>% 
  ...
  geom_bar(position="fill")+
  theme_bw()+
  ggtitle("DOX DARs with DEGs at 3 hours (all)")+
  ylab("proportion")
...
twentyfour_hour_df %>% 
  ...
  geom_bar(position="fill")+
  theme_bw()+
  ggtitle(" significant DEGs in DOX DARs and DOX not-DARs at 24 hours within 2kb of TSS")+
  ylab("proportion")
...
twentyfour_hour_df %>% 
  ...
  geom_bar(position="fill")+
  theme_bw()+
  ggtitle(" significant DEGs in DOX DARs and DOX not-DARs at 24 hours within 20kb")+
  ylab("proportion")
...
twentyfour_hour_df %>% 
 ...
 ggplot(., aes(x=sig_val,fill=DEG))+
  geom_bar(position="fill")+
  theme_bw()+
  ggtitle(" significant DEGs in DOX DARs and DOX not-DARs at 24 hours (all)")+
  ylab("proportion")
