...
annotated_peaks <- all_results %>% 
  ...
  mutate(sig_up= if_else(adj.P.Val_DOX_24<0.05 & logFC_DOX_24>0,"sig_up","not_sig_up")) %>% 
 mutate(sig_down= if_else(adj.P.Val_DOX_24<0.05 & logFC_DOX_24<0,"sig_down","not_sig_down"))
```
