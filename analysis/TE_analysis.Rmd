...
all_TEs_gr <- repeatmasker %>% 
 makeGRangesFromDataFrame(., keep.extra.columns = TRUE, seqnames.field = "genoName", start.field = "genoStart", end.field = "genoEnd",starts.in.df.are.0based=TRUE)
all_TEs_gr$width=width(all_TEs_gr)
...
all_TEs_gr %>% 
  ...
  theme_classic()+
  ggtitle("density of widths of all LINEs across human genome",subtitle = " limited x axis")+
...
all_TEs_gr %>% 
  ...
  ggplot(., aes(x=width))+
    geom_density(aes(fill=repClass, alpha = 0.5))+
  theme_classic()+
  ggtitle("density of widths of all SINEs across human genome")
...
all_TEs_gr %>% 
  ...
  ggplot(., aes(x=width))+
    geom_density(aes(fill=repClass, alpha = 0.5))+
  theme_classic()+
  ggtitle("density of widths of all LTRs across human genome",subtitle = " limited x axis")+
  coord_cartesian(xlim= c(0,2500))
...
all_TEs_gr %>% 
  ...
  ggplot(., aes(x=width))+
    geom_density(aes(fill=repClass, alpha = 0.5))+
  theme_classic()+
  ggtitle("density of widths of all DNA-TEs across human genome",subtitle = " limited x axis")+
  coord_cartesian(xlim= c(0,2500))
...
all_TEs_gr %>% 
  ...
  ggplot(., aes(x=width))+
    geom_density(aes(fill=repClass, alpha = 0.5))+
  theme_classic()+
  ggtitle("density of widths of all Retroposons across human genome",subtitle = " limited x axis")+
  coord_cartesian(xlim= c(0,2500))
...
testingol_col2$width=width(testingol_col2)
