...
EARhypervNR <- matrix(c(chi_TE_nine_mat[1,1],chi_TE_nine_mat[1,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE)%>% chisq.test(.)

EARhypovNR <- matrix(c(chi_TE_nine_mat[2,1],chi_TE_nine_mat[2,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE)%>% chisq.test(.)

ESRAvNR <- matrix(c(chi_TE_nine_mat[3,1],chi_TE_nine_mat[3,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE)%>% chisq.test(.)

ESRBrvNR <- matrix(c(chi_TE_nine_mat[4,1],chi_TE_nine_mat[4,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE)%>% chisq.test(.)

ESRCvNR <- matrix(c(chi_TE_nine_mat[5,1],chi_TE_nine_mat[5,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE)%>% chisq.test(.)

ESRDvNR <- matrix(c(chi_TE_nine_mat[6,1],chi_TE_nine_mat[6,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE)%>% chisq.test(.)

LRhypervNR <- matrix(c(chi_TE_nine_mat[7,1],chi_TE_nine_mat[7,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE) %>% chisq.test(.)

LRhyp0vNR <- matrix(c(chi_TE_nine_mat[8,1],chi_TE_nine_mat[8,2],chi_TE_nine_mat[9,1],chi_TE_nine_mat[9,2]),ncol=2, byrow=TRUE)%>% chisq.test(.)
