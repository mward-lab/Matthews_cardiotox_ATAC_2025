...
EAR_open_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour EAR_open n = ",length(unique(EAR_open_cRE_list$Peakid))," out of ", length(uni_EAR_open$Peakid), " total peaks (",sprintf("%.1f",length(unique(EAR_open_cRE_list$Peakid))/length(uni_EAR_open$Peakid)*100),"%)"))#+
...
EAR_close_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour EAR_close n = ",length(unique(EAR_close_cRE_list$Peakid))," out of ", length(uni_EAR_close$Peakid), " total peaks (",sprintf("%.1f",length(unique(EAR_close_cRE_list$Peakid))/length(uni_EAR_close$Peakid)*100),"%)"))#+
  # facet_wrap(~direction)+
  # theme_bw()+
  # xlim(-4,4)
...
ESR_close_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour ESR_close n = ",length(unique(ESR_close_cRE_list$Peakid))," out of ", length(uni_ESR_close$Peakid), " total peaks (",sprintf("%.1f",length(unique(ESR_close_cRE_list$Peakid))/length(uni_ESR_close$Peakid)*100),"%)"))#+
  # facet_wrap(~direction)+
  # theme_bw()+
  # xlim(-4,4)
...
ESR_open_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour ESR_open n = ",length(unique(ESR_open_cRE_list$Peakid))," out of ", length(uni_ESR_open$Peakid), " total peaks (",sprintf("%.1f",length(unique(ESR_open_cRE_list$Peakid))/length(uni_ESR_open$Peakid)*100),"%)"))#+
  # facet_wrap(~direction)+
  # theme_bw()+
  # xlim(-4,4)
...
ESR_OC_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour ESR_OC n = ",length(unique(ESR_OC_cRE_list$Peakid))," out of ", length(uni_ESR_OC$Peakid), " total peaks (",sprintf("%.1f",length(unique(ESR_OC_cRE_list$Peakid))/length(uni_ESR_OC$Peakid)*100),"%)"))#+
  # facet_wrap(~direction)+
  # theme_bw()+
  # xlim(-4,4)
...
LR_open_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour LR_open n = ",length(unique(LR_open_cRE_list$Peakid))," out of ", length(uni_LR_open$Peakid), " total peaks (",sprintf("%.1f",length(unique(LR_open_cRE_list$Peakid))/length(uni_LR_open$Peakid)*100),"%)"))#+
  # facet_wrap(~direction)+
  # theme_bw()+
  # xlim(-4,4)
...
LR_close_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour LR_close n = ",length(unique(LR_close_cRE_list$Peakid))," out of ", length(uni_LR_close$Peakid), " total peaks (",sprintf("%.1f",length(unique(LR_close_cRE_list$Peakid))/length(uni_LR_close$Peakid)*100),"%)"))#+
  # facet_wrap(~direction)+
  # theme_bw()+
  # xlim(-4,4)
...
NR_cRE_list %>% 
  ...
  geom_boxplot() +
  scale_fill_discrete()+
  ggtitle(paste0(" 24 hour NR n = ",length(unique(NR_cRE_list$Peakid))," out of ", length(uni_NR$Peakid), " total peaks (",sprintf("%.1f",length(unique(NR_cRE_list$Peakid))/length(uni_NR$Peakid)*100),"%)"))#+
  # facet_wrap(~direction)+
  # theme_bw()+
  # xlim(-4,4)
