...
| motif       | gwas_1 (`r length(gwas_1_gr)`)                     | gwas_2 (`r length(gwas_2_gr)`)                     | gwas_3 (`r length(gwas_3_gr)`)                     | gwas_4 (`r length(gwas_4_gr)`)                     | Heart Failure (`r length(gwas_5_gr)`)               | CAD_gwas (`r length(CAD_gwas_gr)`)                   |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
...
| motif       | gwas_1 (`r length(gwas_1_gr)`)                                        | gwas_2 (`r length(gwas_2_gr)`)                                      | gwas_3 (`r length(gwas_3_gr)`)                                        | gwas_4 (`r length(gwas_4_gr)`)                                      | Heart Failure (`r length(gwas_5_gr)`)                                        | CAD_gwas (`r length(CAD_gwas_gr)`)                                      | MI_gwas (`r length(MI_gwas_gr)`)
|--------|--------|--------|--------|--------|--------|--------|--------|--------|
...
These numbers are different than the original lists from which they derived. This is normally due to running `na.omit()` and adding on the `distinct` function to the data frame before GRanges transformation.This reliably removes repeated SNPs. \#
