...
I have made 25 bp +/- files for each of the data sets using the eQTL or SNP location. I also
made a 1bp no extensin file for each of the data sets using the eQTL or SNP location as start and end as +1.
...
findOverlaps(EAR_df_gr, gwas_1_gr_noext)
findOverlaps(ESR_df_gr, gwas_1_gr_noext)
findOverlaps(LR_df_gr, gwas_1_gr_noext)
findOverlaps(NR_df_gr, gwas_1_gr_noext)

findOverlaps(EAR_df_gr, gwas_2_gr_noext)
findOverlaps(ESR_df_gr, gwas_2_gr_noext)
findOverlaps(LR_df_gr,  gwas_2_gr_noext)
findOverlaps(NR_df_gr, gwas_2_gr_noext)


findOverlaps(EAR_df_gr, gwas_3_gr_noext)
findOverlaps(ESR_df_gr, gwas_3_gr_noext)
findOverlaps(LR_df_gr, gwas_3_gr_noext)
findOverlaps(NR_df_gr, gwas_3_gr_noext)

findOverlaps(EAR_df_gr, gwas_4_gr_noext)
findOverlaps(ESR_df_gr, gwas_4_gr_noext)
findOverlaps(LR_df_gr, gwas_4_gr_noext)
findOverlaps(NR_df_gr, gwas_4_gr_noext)

findOverlaps(EAR_df_gr, gwas_5_gr_noext)
findOverlaps(ESR_df_gr, gwas_5_gr_noext)
findOverlaps(LR_df_gr, gwas_5_gr_noext)
findOverlaps(NR_df_gr, gwas_5_gr_noext)
...
| EAR (7321)  | 0           | 2             | 0           | 17            | 0            |
| ESR (15665) | 0           | 30            | 0           | 55            | 2            |
| LR (41759)  | 2           | 29            | 4           | 182           | 15           |
| NR (83658)  | 0           | 90            | 0           | 278           | 11           |
