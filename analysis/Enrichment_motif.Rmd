...
EAR_g4_ol <-findOverlaps(ESR_df_gr, gwas_4_gr_noext)
EAR_g4_ol <-findOverlaps(LR_df_gr, gwas_4_gr_noext)
EAR_g4_ol <-findOverlaps(NR_df_gr, gwas_4_gr_noext)

EAR_g5_ol <-findOverlaps(EAR_df_gr, gwas_5_gr_noext)
EAR_g5_ol <-findOverlaps(ESR_df_gr, gwas_5_gr_noext)
EAR_g5_ol <-findOverlaps(LR_df_gr, gwas_5_gr_noext)
EAR_g5_ol <-findOverlaps(NR_df_gr, gwas_5_gr_noext)

EAR_CAD_ol <-findOverlaps(EAR_df_gr, CAD_gwas_gr_noext)
EAR_CAD_ol <-findOverlaps(ESR_df_gr,  CAD_gwas_gr_noext)
EAR_CAD_ol <-findOverlaps(LR_df_gr,  CAD_gwas_gr_noext)
EAR_CAD_ol <-findOverlaps(NR_df_gr,  CAD_gwas_gr_noext)
...
| motif       | gwas_1 (11)                                        | gwas_2 (1061)                                      | gwas_3 (39)                                        | gwas_4 (6052)                                      | gwas_5 (445)                                        | CAD_gwas (3482)                                      |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
...
| motif       | gwas_1 (11) | gwas_2 (1061) | gwas_3 (39) | gwas_4 (6052) | gwas_5 (445) | CAD_gwas (3482) | MI_gwas (399) |     |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|
...
RNA_expresed_genes_DE %>% 
  ...
  kable(., caption= "RNA DE genes expresssed in LR MRCs that contain SNPs associated with Heart disease") %>% 
...
## ARR, HD, MI, CAD snp overlaps and MRC status
...
### this conversion left me with 13114 genes. some Ids were lost in the conversion, so I will try to figure those locations out.  This led me to adjusting the biomart retrieval by using hgnc symbol, the removing nas from 15497 to 13426.  This was further cut to 12984 using na.omit which excluded those ncbi gene ids (entrezgeneids) that were empty.   I went with the na.omit option overall.
