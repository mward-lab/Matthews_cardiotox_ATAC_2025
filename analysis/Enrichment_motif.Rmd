...
hits_col2 <- hits[percentOverlap_col > 0.5]
Col_fullDF_overlap %>% as.data.frame


# TEST$Deft <- NA
# TEST$Deft[subjectHits(hits)] <- REF$Deft[queryHits(hits)]
testingol_col <- Col_TSS_data_gf[queryHits((hits_col2))]
testingol_col %>% as.data.frame() %>% 
