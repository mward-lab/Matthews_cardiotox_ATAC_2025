...
### EAR 20,000 bp NG 
```{r GO_EAR_20k}
# EAR_resgenes_20k <- gost(query = EAR_peak_list_20k$NCBI_gene,
#                     organism = "hsapiens",
#                     significant = FALSE,
#                     ordered_query = FALSE,
#                     domain_scope = "custom",
...
### ESR 20,000 bp NG 
```{r GO_ESR_20k}
# ESR_resgenes_20k <- gost(query = ESR_peak_list_20k$NCBI_gene,
#                     organism = "hsapiens",
#                     significant = FALSE,
#                     ordered_query = FALSE,
#                     domain_scope = "custom",
...
### LR 20,000 bp NG 
```{r GO_LR_20k}
# LR_resgenes_20k <- gost(query = LR_peak_list_20k$NCBI_gene,
#                     organism = "hsapiens",
#                     significant = FALSE,
#                     ordered_query = FALSE,
#                     domain_scope = "custom",
...
### NR 20,000 bp NG 
```{r GO_NR_20k}
# NR_resgenes_20k <- gost(query = NR_peak_list_20k$NCBI_gene,
#                     organism = "hsapiens",
#                     significant = FALSE,
#                     ordered_query = FALSE,
#                     domain_scope = "custom",
