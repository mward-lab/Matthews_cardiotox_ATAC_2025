...
```{r GOBP}
GO_KEGG_analysis(EAR_open_NG_2kresgenes,"GO:BP", 0.05)
GO_KEGG_analysis(EAR_close_NG_2kresgenes,"GO:BP", 0.05)
GO_KEGG_analysis(ESR_open_NG_2kresgenes,"GO:BP", 0.05)
GO_KEGG_analysis(ESR_close_NG_2kresgenes,"GO:BP", 0.05)
GO_KEGG_analysis(ESR_OC_NG_2kresgenes,"GO:BP", 0.05)
GO_KEGG_analysis(LR_open_NG_2kresgenes,"GO:BP", 0.05)
GO_KEGG_analysis(LR_close_NG_2kresgenes,"GO:BP", 0.05)
GO_KEGG_analysis(NR_NG_2kresgenes,"GO:BP", 0.05)
...
GO_KEGG_analysis(NR_NG_2kresgenes,"KEGG", 0.05)
```
