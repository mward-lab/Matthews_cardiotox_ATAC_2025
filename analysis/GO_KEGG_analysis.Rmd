...
filter(source=="GO:BP") %>% 
  ...
  ggtitle("EAR_hyper accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("EAR_hyper accessible KEGG pathways")
...
filter(source=="GO:BP") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("EAR_hypo accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("EAR_hypo accessible KEGG pathways")
```
...
filter(source=="GO:BP") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("ESR_hyper accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("ESR_hyper accessible KEGG pathways")
...
filter(source=="GO:BP") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("ESR_hypo accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("ESR_hypo accessible KEGG pathways")
```
...
filter(source=="GO:BP") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("LR_hyper accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("LR_hyper accessible KEGG pathways")
...
filter(source=="GO:BP") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("LR_hypo accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("LR_hypo accessible KEGG pathways")
```
...
filter(source=="GO:BP") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("NR_hyper accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("NR_hyper accessible KEGG pathways")
...
filter(source=="GO:BP") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("NR_hypo accessible GO:BP terms")
...
filter(source=="KEGG") %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("NR_hypo accessible KEGG pathways")
```
