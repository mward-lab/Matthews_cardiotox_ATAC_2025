...
holder_EAR_open <- meme_motifs_EAR_open[[6]]
...
# motif_EAR_open_6_results <- lapply(seq_all_cd_200, function(sequences) {
  # matchMotifs(pw_matrix_earo, sequences, out = "positions")
# })

# motifstorage_earo <-motif_positions_df <- do.call(rbind, lapply(seq_along(motif_EAR_open_6_results), function(i) {
#   positions <- motif_EAR_open_6_results[[i]]  # Positions from matchMotifs
...
# }))
#   
#  saveRDS(motifstorage_earo, "data/Final_four_data/matchr_EAR_open_6.RDS")
