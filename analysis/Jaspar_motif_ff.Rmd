...
```{r enriched motifs EARopen, fig.height=8,eval=FALSE, include=FALSE}
# ER_rat <- 1.1
# mrc_type <- "EAR_open"
# spec_dataframe %>% 
...
##### EAR_close
```{r enriched motifs EAR_close, fig.height=8,eval=FALSE, include=FALSE}
# ER_rat <- 1.5
# mrc_type <- "EAR_close"
# spec_dataframe %>% 
#   dplyr::filter(mrc==mrc_type) %>% 
...
```{r enriched motifs ESR_open, fig.height=8,eval=FALSE, include=FALSE}
# ER_rat <- 1.5
# mrc_type <- "ESR_open"
# spec_dataframe %>% 
...
```{r enriched motifs ESR_close, fig.height=8,eval=FALSE, include=FALSE}
# ER_rat <- 1.5
# mrc_type <- "ESR_close"
# spec_dataframe %>% 
#   dplyr::filter(mrc==mrc_type) %>% 
...
```{r enriched motifs ESR_OC, fig.height=8,eval=FALSE, include=FALSE}
# ER_rat <- 1.5
# mrc_type <- "ESR_OC"
# spec_dataframe %>% 
#   dplyr::filter(mrc==mrc_type) %>% 
...
```{r enriched motifs LR_open, fig.height=8,eval=FALSE, include=FALSE}
# ER_rat <- 1.5
# mrc_type <- "LR_open"
# spec_dataframe %>% 
#   dplyr::filter(mrc==mrc_type) %>% 
...
```{r enriched motifs LR_close, fig.height=8,eval=FALSE, include=FALSE}
# ER_rat <- 1.25
# mrc_type <- "LR_close"
# spec_dataframe %>% 
#   dplyr::filter(mrc==mrc_type) %>% 
...
```{r top, eval=FALSE, include=FALSE}
# spec_dataframe_200 %>% 
#   # dplyr::filter(stringr::str_detect( motif_name,"Mafg^*")) %>%
#   dplyr::filter(mrc=="ESR_open") %>%
#   # dplyr::select(RANK,CLUSTER,ENR_RATIO,SIM_MOTIF,ALT_ID, ID,EVALUE.x, TP:'FP%', motif_name)%>%
