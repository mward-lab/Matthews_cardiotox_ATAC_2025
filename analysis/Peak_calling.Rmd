...
ChipSeekR::plotAvgProf(Ind4_TSS_peaks_plot[c(1,3,5,7,9,11)], xlim=c(-3000, 3000), ylab = "Count Frequency")+ ggtitle("3 hour Individual 4" )
...
```{r small frip scores by individual}


all_frip1 %>% rename("FRiP_score"="FRiP_1") %>% 
  rbind(all_frip2%>% rename("FRiP_score"="FRiP_2")) %>% 
  rbind(all_frip3%>% rename("FRiP_score"="FRiP_3")) %>%
  rbind(all_frip6%>% rename("FRiP_score"="FRiP_6")) %>% 
