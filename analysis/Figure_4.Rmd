...
Figure 4: Drug-induced chromatin accessibility changes correspond to changes in active histone modification enrichment and gene expression.
```{r}
knitr::include_graphics("assets/Figure_4.png", error=FALSE)
knitr::include_graphics("docs/assets/Figure_4.png",error = FALSE)
