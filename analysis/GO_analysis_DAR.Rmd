...
DOX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
DOX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
DOX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR pairs (within 20kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
DOX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DOX_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
DOX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DOX_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
# EPI_DAR_DEG_24hour_20kb_up_res <- gost(query = EPI_DAR_DEG_24hour_20kb_up$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(EPI_DAR_DEG_24hour_20kb_up_res,"data/Final_four_data/re_analysis/EPI_DAR_DEG_24hour_20kb_up_res.RDS")
```

```{r EPI_DAR 20 up GO, fig.height=10}
...
EPI_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down EPI_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
EPI_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down EPI_DAR pairs (within 20kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
```{r DNR_DAR up GO 20kb, fig.height=10}
...
DNR_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
DNR_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```


```{r DNR_DAR up KEGG 20kb}
DNR_DD_24_up_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR pairs (within 20kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```

```{r DNR_DAR down GO 20kb, fig.height=10}
...
DNR_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DNR_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
DNR_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DNR_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```


```{r DNR_DAR down KEGG 20kb}
DNR_DD_24_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DNR_DAR pairs (within 20kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
length(MTX_DAR_DEG_24hour_2kb_up$geneId)
...
# MTX_DAR_DEG_3hour_2kb_down_res <- gost(query = MTX_DAR_DEG_3hour_2kb_down$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(MTX_DAR_DEG_3hour_2kb_down_res,"data/Final_four_data/re_analysis/MTX_DAR_DEG_3hour_2kb_down_res.RDS")
```

```{r MTX_DAR up GO, fig.height=10}
...
MTX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
MTX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```
...
```{r MTX_DAR down GO, fig.height=10}
...
MTX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
MTX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
length(MTX_DAR_DEG_24hour_20kb_up$geneId)
...
# MTX_DAR_DEG_24hour_20kb_up_res <- gost(query = MTX_DAR_DEG_24hour_20kb_up$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(MTX_DAR_DEG_24hour_20kb_up_res,"data/Final_four_data/re_analysis/MTX_DAR_DEG_24hour_20kb_up_res.RDS")
```

```{r MTX_DAR up GO 20kb, fig.height=5}
...
MTX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
MTX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```


```{r MTX_DAR up KEGG 20kb}
MTX_DD_24_up_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
...
```{r MTX_DAR down GO 20kb, fig.height=10}
...
MTX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
MTX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```


```{r MTX_DAR down KEGG 20kb}
MTX_DD_24_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR pairs (within 20kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
