...
```
the length of DOX_3 hour DAR_DEGS is `r length(DOX_DAR_DEG_3hour_2kb$geneId)` so no enrichment could take place.
### DOX 24hr 2kb  

```{r DOX_DAR 24 hour GO, fig.height=10}
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour DOX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
...
DOX_DD_24_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour DOX_DAR_DEG pairs (within 2kb of TSS) KEGG enriched terms top 60")
```
...
making the  up data frames
```{r}

DOX_DAR_DEG_3hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DOX3_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% DOX3_degs$ENTREZID) %>% 
   distinct(geneId)

DOX_DAR_DEG_24hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DOX24_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% DOX24_degs$ENTREZID) %>% 
  distinct(geneId)

DOX_DAR_DEG_3hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DOX3_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% DOX3_degs$ENTREZID) %>% 
  distinct(geneId)

DOX_DAR_DEG_24hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DOX24_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% DOX24_degs$ENTREZID) %>% 
  distinct(geneId)


# DOX_DAR_DEG_3hour_down_res <- gost(query = DOX_DAR_DEG_3hour_down$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(DOX_DAR_DEG_3hour_down_res,"data/Final_four_data/re_analysis/DOX_DAR_DEG_3hour_down_res.RDS")

DOX_DAR_DEG_3hour_up_res <- readRDS("data/Final_four_data/re_analysis/DOX_DAR_DEG_3hour_up_res.RDS")
DOX_DAR_DEG_3hour_down_res <- readRDS("data/Final_four_data/re_analysis/DOX_DAR_DEG_3hour_down_res.RDS")

DOX_DAR_DEG_24hour_up_res <- readRDS("data/Final_four_data/re_analysis/DOX_DAR_DEG_24hour_up_res.RDS")
DOX_DAR_DEG_24hour_down_res <- readRDS("data/Final_four_data/re_analysis/DOX_DAR_DEG_24hour_down_res.RDS")
...
up
### DOX DAR_DEG up all 3 hours
```{r DOX_DAR_DEG_up all 3 hour}


DOX_DDall_3_up_nomtable <-  DOX_DAR_DEG_3hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DOX_DDall_3_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up DOX_DAR_DEG_pairs 3hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DOX_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up DOX_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up DOX_DAR pairs GO:MF enriched terms top 60")
```
DOX DAR_DEG up all 3 hours kegg
```{r}
...
DOX_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up DOX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```


### DOX DAR_DEG down all 3 hours
```{r DOX_DAR_DEG_down all 3 hour}


DOX_DDall_3_down_nomtable <-  DOX_DAR_DEG_3hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DOX_DDall_3_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down DOX_DAR_DEG_pairs 3hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DOX_DDall_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down DOX_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour down DOX_DAR pairs GO:MF enriched terms top 60")
```
DOX DAR_DEG down all 3 hours kegg
```{r}
DOX_DDall_3_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down DOX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```


### DOX DAR DEG up all 24 hours
```{r DOX_DAR_DEG_up all 24 hour}


DOX_DDall_24_up_nomtable <-  DOX_DAR_DEG_24hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DOX_DDall_24_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
...
DOX_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up DOX_DAR pairs GO:MF enriched terms top 60")
```
DOX DAR DEG up all 24 hours kegg
```{r}
...
DOX_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```


### DOX DAR DEG down all 24 hours
```{r DOX_DAR_DEG_down all 24 hour}


DOX_DDall_24_down_nomtable <-  DOX_DAR_DEG_24hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DOX_DDall_24_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
...
DOX_DDall_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DOX_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down DOX_DAR pairs GO:MF enriched terms top 60")
```
DOX DAR DEG down all 24 hours kegg
```{r}
DOX_DDall_24_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DOX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```

Now to zoom in and focus on the genes that are near regions by TSS
### DOX up and down 2kb
```{r}
...
```
### DOX up and down 2kb 3 hour

There was not enough DAR_DEG 3 hour pairs in 2kb to do enrichment with GO:BP.
### DOX up 2kb 24 hour
...
DOX_DD_24_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up DOX_DAR_DEG_pairs 2kb 24 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DOX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up DOX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```
...
DOX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR_DEG pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
### DOX down 2kb 24 hour
...
DOX_DD_24_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in 2kb down DOX_DAR_DEG_pairs 24hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DOX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DOX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down DOX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
```
### DOX 24 hour up 20kb
```{r DOX_DAR up GO 20kb, fig.height=10}
...
DOX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DOX_DAR_DEG pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up DOX_DAR_DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
```{r DOX_DAR down GO 20kb, fig.height=10}
...
DOX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DOX_DAR_DEG pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down DOX_DAR_DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
EPI_DD_3_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in EPI_DAR_DEG_pairs 3 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DD_3_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour EPI_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60")

### parsing similar terms:  
```

### EPI 3 hour 2kb DAR DEGS KEGG  
...
EPI_DD_3_nomtable %>%
  ...
  # dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "ALL Kegg terms found in EPI_DAR_DEG_pairs 3 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DD_24_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour EPI_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60")

### parsing similar terms:  
```

### EPI 24hr DAR DEG 2kb KEGG  
...
EPI_DD_24_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour EPI_DAR_DEG pairs (within 2kb of TSS) KEGG enriched terms top 60")
```
...
EPI_DD_2420kb_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour EPI_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60 20kb")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour EPI_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60 20kb")
```
...
EPI_DAR_DEG_3hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%EPI3_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% EPI3_degs$ENTREZID) %>% 
   distinct(geneId)

EPI_DAR_DEG_24hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%EPI24_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% EPI24_degs$ENTREZID) %>% 
  distinct(geneId)

EPI_DAR_DEG_3hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%EPI3_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% EPI3_degs$ENTREZID) %>% 
  distinct(geneId)

EPI_DAR_DEG_24hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%EPI24_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% EPI24_degs$ENTREZID) %>% 
  distinct(geneId)

# 
# EPI_DAR_DEG_24hour_up_res <- gost(query = EPI_DAR_DEG_24hour_up$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(EPI_DAR_DEG_24hour_up_res,"data/Final_four_data/re_analysis/EPI_DAR_DEG_24hour_up_res.RDS")

EPI_DAR_DEG_3hour_up_res <- readRDS("data/Final_four_data/re_analysis/EPI_DAR_DEG_3hour_up_res.RDS")
EPI_DAR_DEG_3hour_down_res <- readRDS("data/Final_four_data/re_analysis/EPI_DAR_DEG_3hour_down_res.RDS")

EPI_DAR_DEG_24hour_up_res <- readRDS("data/Final_four_data/re_analysis/EPI_DAR_DEG_24hour_up_res.RDS")
EPI_DAR_DEG_24hour_down_res <- readRDS("data/Final_four_data/re_analysis/EPI_DAR_DEG_24hour_down_res.RDS")

```

After running gprofiler2, i saved the results as .RDS files to save time in the future. Now I just extract the information and graph.
up
### EPI DAR DEG up all 3 hours
```{r EPI_DAR_DEG_up all 3 hour}


EPI_DDall_3_up_nomtable <-  EPI_DAR_DEG_3hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

EPI_DDall_3_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up EPI_DAR_DEG_pairs 3hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up EPI_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up EPI_DAR pairs GO:MF enriched terms top 60")
```
EPI DAR DEG up all 3 hours kegg
```{r}
...
EPI_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up EPI_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```

### EPI DAR DEG down all 3 hours
```{r EPI_DAR_DEG_down all 3 hour}


EPI_DDall_3_down_nomtable <-  EPI_DAR_DEG_3hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

EPI_DDall_3_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down EPI_DAR_DEG_pairs 3hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DDall_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down EPI_DAR pairs GO:BP enriched terms top 45")
...
EPI_DDall_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down EPI_DAR pairs GO:MF enriched terms top 60")
```
EPI DAR DEG down all 3 hours kegg
```{r}
EPI_DDall_3_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down EPI_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```

### EPI DAR DEG up all 24 hours
```{r EPI_DAR_DEG_up all 24 hour}


EPI_DDall_24_up_nomtable <-  EPI_DAR_DEG_24hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

EPI_DDall_24_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
...
EPI_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up EPI_DAR pairs GO:BP enriched terms top 45")
...
EPI_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up EPI_DAR pairs GO:MF enriched terms top 60")
```
EPI DAR DEG up all 24 hours kegg
```{r}
...
EPI_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up EPI_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```

### EPI DAR DEG down all 24 hours
```{r EPI_DAR_DEG_down all 24 hour}


EPI_DDall_24_down_nomtable <-  EPI_DAR_DEG_24hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

EPI_DDall_24_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
...
EPI_DDall_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down EPI_DAR_DEG pairs GO:BP enriched terms top 45")
...
EPI_DDall_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down EPI_DAR_DEG pairs GO:MF enriched terms top 60")
```
EPI DAR DEG down all 24 hours kegg
```{r}
EPI_DDall_24_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down EPI_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```
...
```
### EPI 3 hours 2kb up
```{r EPI_DAR up 3 GO, fig.height=10}
# EPI_DAR_DEG_3hour_2kb_up_res$result

EPI_DD_3_up_nomtable <-  EPI_DAR_DEG_3hour_2kb_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
EPI_DD_3_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up EPI_DAR_DEG_pairs 3 hours 2kb ") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DD_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up EPI_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up EPI_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```
EPI 3 hours 2kb up KEGG
```{r EPI_DAR3 up KEGG}
EPI_DD_3_up_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up EPI_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
### EPI 3 hours 2kb down
```{r EPI_DAR3 down GO, fig.height=10}

# EPI_DAR_DEG_3hour_2kb_down_res$result

EPI_DD_3_down_nomtable <-  EPI_DAR_DEG_3hour_2kb_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
EPI_DD_3_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down EPI_DAR_DEG_pairs 3hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DD_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down EPI_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour down EPI_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
EPI 3 hours 2kb down KEGG
```{r EPI_DAR 3 down KEGG}
EPI_DD_3_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down EPI_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
```{r EPI_DAR up 24 GO, fig.height=10}
...
EPI_DD_24_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up EPI_DAR_DEG_pairs 24 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up EPI_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up EPI_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```

EPI 24 hours 2kb up KEGG
```{r EPI_DAR24 up KEGG}
EPI_DD_24_up_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
...
### parsing similar terms:  
```
### EPI 24 hours 2kb down
```{r EPI_DAR24 down GO, fig.height=10}
...
EPI_DD_24_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down EPI_DAR_DEG_pairs 24 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down EPI_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down EPI_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```

EPI 24 hours 2kb down KEGG
```{r EPI_DAR 24 down KEGG}
EPI_DD_24_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up EPI_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down EPI_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up EPI_DAR DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
```{r EPI_DAR down GO 20kb, fig.height=10}
...
EPI_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down EPI_DAR_DEG pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down EPI_DAR_DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
3 hour 2kb and 24 hour 2kb DAR DEGS
```{r}
...
### DNR 3hr 2kb DAR DEGS  

```{r DNR_DAR_DEG_3hour_2kb GO, fig.height=10}
...
DNR_DD_3_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in DNR_DAR_DEG_pairs 3 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DD_3_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour DNR_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60")

### parsing similar terms:  
```

### DNR 3hr 2kb DAR DEGS KEGG 

```{r DNR_DD_3_nomtable KEGG}
DNR_DD_3_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  # dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
...
### DNR 24 hr 2kb DAR DEGS 

```{r DNR_DD_24 GO, fig.height=10}
...
DNR_DD_24_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in DNR_DAR_DEG_pairs 24 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DD_24_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour DNR_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60")

### parsing similar terms:  
```

### DNR 24 hr 2kb DAR DEGS KEGG  
...
DNR_DD_24_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour DNR_DAR_DEG pairs (within 2kb of TSS) KEGG enriched terms top 60")
```
...
DNR_DD_2420kb_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour DNR_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60 20kb")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour DNR_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60 20kb")
```
...
DNR_DAR_DEG_3hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DNR3_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% DNR3_degs$ENTREZID) %>% 
   distinct(geneId)

DNR_DAR_DEG_24hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DNR24_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% DNR24_degs$ENTREZID) %>% 
  distinct(geneId)

DNR_DAR_DEG_3hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DNR3_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% DNR3_degs$ENTREZID) %>% 
  distinct(geneId)

DNR_DAR_DEG_24hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%DNR24_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% DNR24_degs$ENTREZID) %>% 
  distinct(geneId)

# 
# DNR_DAR_DEG_24hour_down_res <- gost(query = DNR_DAR_DEG_24hour_down$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(DNR_DAR_DEG_24hour_down_res,"data/Final_four_data/re_analysis/DNR_DAR_DEG_24hour_down_res.RDS")

DNR_DAR_DEG_3hour_up_res <- readRDS("data/Final_four_data/re_analysis/DNR_DAR_DEG_3hour_up_res.RDS")
DNR_DAR_DEG_3hour_down_res <- readRDS("data/Final_four_data/re_analysis/DNR_DAR_DEG_3hour_down_res.RDS")

DNR_DAR_DEG_24hour_up_res <- readRDS("data/Final_four_data/re_analysis/DNR_DAR_DEG_24hour_up_res.RDS")
DNR_DAR_DEG_24hour_down_res <- readRDS("data/Final_four_data/re_analysis/DNR_DAR_DEG_24hour_down_res.RDS")

```

After running gprofiler2, i saved the results as .RDS files to save time in the future. Now I just extract the information and graph.
up
### DNR DAR DEG up all 3 hours
```{r DNR_DAR_DEG_up all 3 hour}


DNR_DDall_3_up_nomtable <-  DNR_DAR_DEG_3hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DNR_DDall_3_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up DNR_DAR_DEG_pairs 3 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up DNR_DAR_DEG pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up DNR_DAR_DEG pairs GO:MF enriched terms top 60")
```
DNR DAR DEG up all 3 hours kegg
```{r}
...
DNR_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up DNR_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```

### DNR DAR DEG down all 3 hours
```{r DNR_DAR_DEG_down all 3 hour}

DNR_DDall_3_down_nomtable <-  DNR_DAR_DEG_3hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DNR_DDall_3_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down DNR_DAR_DEG_pairs 3 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DDall_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down DNR_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour down DNR_DAR pairs GO:MF enriched terms top 60")
```
DNR DAR DEG down all 3 hours kegg
```{r}
DNR_DDall_3_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down DNR_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```

### DNR DAR DEG up all 24 hours
```{r DNR_DAR_DEG_up all 24 hour}


DNR_DDall_24_up_nomtable <-  DNR_DAR_DEG_24hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DNR_DDall_24_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
...
DNR_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR pairs GO:BP enriched terms top 45")
...
DNR_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR pairs GO:MF enriched terms top 60")
```
DNR DAR DEG up all 24 hours kegg
```{r}
...
DNR_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```


### DNR DAR DEG down all 24 hours
```{r DNR_DAR_DEG_down all 24 hour}


DNR_DDall_24_down_nomtable <-  DNR_DAR_DEG_24hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

DNR_DDall_24_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
...
DNR_DDall_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DNR_DAR_DEG pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down DNR_DAR_DEG pairs GO:MF enriched terms top 60")
```
DNR DAR DEG down all 24 hours kegg
```{r}
DNR_DDall_24_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DNR_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```
...
# DNR_DAR_DEG_3hour_2kb_down_res <- gost(query = DNR_DAR_DEG_3hour_2kb_down$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(DNR_DAR_DEG_3hour_2kb_down_res,"data/Final_four_data/re_analysis/DNR_DAR_DEG_3hour_2kb_down_res.RDS")
```
### DNR 3 hours 2kb up 
```{r DNR_DAR up 3 GO, fig.height=10}
# DNR_DAR_DEG_3hour_2kb_up_res$result

DNR_DD_3_up_nomtable <-  DNR_DAR_DEG_3hour_2kb_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
DNR_DD_3_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up DNR_DAR_DEG_pairs 3 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DD_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up DNR_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up DNR_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```
DNR 3 hours up 2kb KEGG
...
DNR_DD_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up DNR_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
### DNR 3 hours 2kb down 
```{r DNR_DAR3 down GO, fig.height=10}

# DNR_DAR_DEG_3hour_2kb_down_res$result

DNR_DD_3_down_nomtable <-  DNR_DAR_DEG_3hour_2kb_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
DNR_DD_3_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down DNR_DAR_DEG_pairs 3 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DD_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down DNR_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour down DNR_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
DNR 3 hours 2kb down KEGG

```{r DNR_DAR 3 down KEGG}
DNR_DD_3_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down DNR_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
```{r DNR_DAR up 24 GO, fig.height=10}
...
DNR_DD_24_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up DNR_DAR_DEG_pairs 24 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up DNR_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```

DNR 24 hours 2kb up KEGG
```{r DNR_DAR24 up KEGG}
DNR_DD_24_up_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
...
### parsing similar terms:  
```
### DNR 24 hours 2kb down
```{r DNR_DAR24 down GO, fig.height=10}
...
DNR_DD_24_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down DNR_DAR_DEG_pairs 24 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down DNR_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down DNR_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```

DNR 24 hours 2kb down KEGG
```{r DNR_DAR 24 down KEGG}
DNR_DD_24_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour down DNR_DAR_DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
DNR_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up DNR_DAR DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down DNR_DAR_DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
...
MTX_DAR_DEG_3hour_2kb_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_3hour_2kb_res.RDS")

# MTX_DAR_DEG_3hour_2kb_res <- gost(query = MTX_DAR_DEG_3hour_2kb$geneId,
#                     organism = "hsapiens",
#                     significant = FALSE,
#                     ordered_query = FALSE,
#                     domain_scope = "custom",
...
#                     sources=c("GO:BP","KEGG","GO:MF"))
# 
# saveRDS(MTX_DAR_DEG_3hour_2kb_res,"data/Final_four_data/re_analysis/MTX_DAR_DEG_3hour_2kb_res.RDS")
...
### MTX 3hr 2kb DAR DEGS 

```{r MTX_DAR_DEG_3hour_2kb GO, fig.height=10}

# MTX_DAR_DEG_3hour_2kb_res$result

MTX_DD_3_nomtable <-  MTX_DAR_DEG_3hour_2kb_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
MTX_DD_3_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in MTX_DAR_DEG_pairs 3 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DD_3_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour MTX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60")

### parsing similar terms:  
```

### MTX 3hr 2kb DAR DEGS KEGG  

```{r MTX_DD_3_nomtable KEGG}
MTX_DD_3_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  # dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "ALL Kegg terms found in MTX_DAR_DEG_pairs 3 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DD_3_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour MTX_DAR_DEG pairs (within 2kb of TSS) KEGG enriched terms top 60")
```
...
### MTX 24hr 2kb DAR DEGS 

```{r MTX_DD_24 GO, fig.height=10}
...
MTX_DD_24_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in MTX_DAR_DEG_pairs 24 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DD_24_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour MTX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60")

### parsing similar terms:  
```

### MTX 24hr 2kb DAR DEGS KEGG  
...
MTX_DD_24_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour MTX_DAR_DEG pairs (within 2kb of TSS) KEGG enriched terms top 60")
```
...
MTX_DD_2420kb_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour MTX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 60 20kb")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour MTX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60 20kb")
```
...
MTX_DAR_DEG_3hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX3_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% MTX3_degs$ENTREZID) %>% 
   distinct(geneId)

MTX_DAR_DEG_24hour_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX24_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% MTX24_degs$ENTREZID) %>% 
  distinct(geneId)

MTX_DAR_DEG_3hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX3_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% MTX3_degs$ENTREZID) %>% 
  distinct(geneId)

MTX_DAR_DEG_24hour_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX24_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% MTX24_degs$ENTREZID) %>% 
  distinct(geneId)

# 
# MTX_DAR_DEG_24hour_up_res <- gost(query = MTX_DAR_DEG_24hour_up$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(MTX_DAR_DEG_24hour_up_res,"data/Final_four_data/re_analysis/MTX_DAR_DEG_24hour_up_res.RDS")

MTX_DAR_DEG_3hour_up_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_3hour_up_res.RDS")
MTX_DAR_DEG_3hour_down_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_3hour_down_res.RDS")

MTX_DAR_DEG_24hour_up_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_24hour_up_res.RDS")
MTX_DAR_DEG_24hour_down_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_24hour_down_res.RDS")

```

After running gprofiler2, i saved the results as .RDS files to save time in the future. Now I just extract the information and graph.
up
### MTX DAR DEG up all 3 hours
```{r MTX_DAR_DEG_up all 3 hour}
MTX_DDall_3_up_nomtable <-  MTX_DAR_DEG_3hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

MTX_DDall_3_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up MTX_DAR_DEG_pairs 3 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up MTX_DAR_DEG pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up MTX_DAR_DEG pairs GO:MF enriched terms top 60")
```
MTX DAR DEG up all 3 hours kegg
```{r}
...
MTX_DDall_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up MTX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```


### MTX DAR DEG down all 3 hours
```{r MTX_DAR_DEG_down all 3 hour}


MTX_DDall_3_down_nomtable <-  MTX_DAR_DEG_3hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

MTX_DDall_3_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down MTX_DAR_DEG_pairs 3 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DDall_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down MTX_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour down MTX_DAR pairs GO:MF enriched terms top 60")
```
MTX DAR DEG down all 3 hours kegg
```{r}
MTX_DDall_3_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down MTX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```

### MTX DAR DEG up all 24 hours
```{r MTX_DAR_DEG_up all 24 hour}


MTX_DDall_24_up_nomtable <-  MTX_DAR_DEG_24hour_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

MTX_DDall_24_up_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up MTX_DAR_DEG_pairs 24hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR pairs GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up MTX_DAR pairs GO:MF enriched terms top 60")
```
MTX DAR DEG up all 24 hours kegg
```{r}
...
MTX_DDall_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```


### MTX DAR DEG down all 24 hours
```{r MTX_DAR_DEG_down all 24 hour}


MTX_DDall_24_down_nomtable <-  MTX_DAR_DEG_24hour_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))

MTX_DDall_24_down_nomtable %>%
  dplyr::filter(source=="GO:BP") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down MTX_DAR_DEG_pairs 24 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DDall_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR_DEG pairs GO:BP enriched terms top 45")
...
# MTX_DDall_24_down_nomtable %>%
  ...
  # guides(fill="none")+
  # theme(axis.text.y = element_text(color="black"))+
  # ggtitle("24 hour down MTX_DAR_DEG pairs GO:MF enriched terms top 60")
```
MTX DAR DEG down all 24 hours kegg
```{r}
MTX_DDall_24_down_nomtable %>% 
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR_DEG pairs  KEGG enriched terms top 60")
### parsing similar terms:  
```
...
MTX_DAR_DEG_3hour_2kb_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX3_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% MTX3_degs$ENTREZID) %>% 
  dplyr::filter(distanceToTSS >-2000 & distanceToTSS <2000) %>% 
  distinct(geneId)

MTX_DAR_DEG_24hour_2kb_up <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX24_DAR_up$Peakid) %>% 
  dplyr::filter(geneId %in% MTX24_degs$ENTREZID) %>% 
  dplyr::filter(distanceToTSS >-2000 & distanceToTSS <2000) %>%
  distinct(geneId)

MTX_DAR_DEG_3hour_2kb_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX3_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% MTX3_degs$ENTREZID) %>% 
  dplyr::filter(distanceToTSS >-2000 & distanceToTSS <2000) %>% 
  distinct(geneId)

MTX_DAR_DEG_24hour_2kb_down <- Assigned_genes_toPeak %>% 
  dplyr::filter(Peakid %in%MTX24_DAR_down$Peakid) %>% 
  dplyr::filter(geneId %in% MTX24_degs$ENTREZID) %>% 
  dplyr::filter(distanceToTSS >-2000 & distanceToTSS <2000) %>%
  distinct(geneId)
length(MTX_DAR_DEG_3hour_2kb_down$geneId)
length(MTX_DAR_DEG_24hour_2kb_down$geneId)

MTX_DAR_DEG_3hour_2kb_up_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_3hour_2kb_up_res.RDS")
MTX_DAR_DEG_3hour_2kb_down_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_3hour_2kb_down_res.RDS")
MTX_DAR_DEG_24hour_2kb_up_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_24hour_2kb_up_res.RDS")
MTX_DAR_DEG_24hour_2kb_down_res <- readRDS("data/Final_four_data/re_analysis/MTX_DAR_DEG_24hour_2kb_down_res.RDS")
# MTX_DAR_DEG_24hour_2kb_down_res <- gost(query = MTX_DAR_DEG_24hour_2kb_down$geneId,
# organism = "hsapiens",
# significant = FALSE,
# ordered_query = FALSE,
# domain_scope = "custom",
...
# custom_bg = RNA_all_expressed$ENTREZID,
# sources=c("GO:BP","KEGG","GO:MF"))
# saveRDS(MTX_DAR_DEG_24hour_2kb_down_res,"data/Final_four_data/re_analysis/MTX_DAR_DEG_24hour_2kb_down_res.RDS")
```
### MTX 3 hour 2kb up  

```{r MTX_DAR up 3 GO, fig.height=10}
MTX_DAR_DEG_3hour_2kb_up_res$result

MTX_DD_3_up_nomtable <-  MTX_DAR_DEG_3hour_2kb_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
MTX_DD_3_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up MTX_DAR_DEG_pairs 3 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DD_3_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up MTX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#     geom_col()+
  ...
  # guides(fill="none")+
  # theme(axis.text.y = element_text(color="black"))+
  # ggtitle("3 hour up MTX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```

MTX 3 hour 2kb up KEGG
```{r MTX_DAR3 up KEGG}
MTX_DD_3_up_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour up MTX_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
### MTX 3 hour 2kb down

NO results
```{r MTX_DAR3 down GO, fig.height=10, eval=FALSE}

# MTX_DAR_DEG_3hour_2kb_down_res$result

MTX_DD_3_down_nomtable <-  MTX_DAR_DEG_3hour_2kb_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
MTX_DD_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down MTX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
MTX_DD_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down MTX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
```{r MTX_DAR 3 down KEGG, eval=FALSE}
MTX_DD_3_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down MTX_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
```{r MTX_DAR up 24 GO, fig.height=10}
MTX_DAR_DEG_24hour_2kb_up_res$result

MTX_DD_24_up_nomtable <-  MTX_DAR_DEG_24hour_2kb_up_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
MTX_DD_24_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up MTX_DAR_DEG_pairs 24 hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour up MTX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
```

MTX 24 hours 2kb up KEGG
```{r MTX_DAR24 up KEGG}
MTX_DD_24_up_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
### MTX 24 hours 2kb down 

```{r MTX_DAR24 down GO, fig.height=10}

# MTX_DAR_DEG_24hour_2kb_down_res$result

MTX_DD_24_down_nomtable <-  MTX_DAR_DEG_24hour_2kb_down_res$result %>%
  dplyr::select(c(source, term_id,
                  term_name,intersection_size, 
                   term_size, p_value))
...
MTX_DD_24_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down MTX_DAR_DEG_pairs 24hours 2kb") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DD_24_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR_DEG pairs (within 2kb of TSS) GO:BP enriched terms top 45")
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down MTX_DAR_DEG pairs (within 2kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```

MTX 24 hours 2kb down KEGG
```{r MTX_DAR 24 down KEGG}
MTX_DD_24_down_nomtable %>%
  dplyr::filter(source=="KEGG") %>% 
  dplyr::filter(p_value < 0.05) %>% 
  mutate(log10_p=(-log(p_value, base=10))) %>% 
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour down MTX_DAR pairs (within 2kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
```
### MTX 3 hours 20kb up
```{r MTX_DAR 20 3 up GO, fig.height=10}
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("3 hour up MTX_DAR_DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
MTX_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up MTX_DAR DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
#   guides(fill="none")+
#   theme(axis.text.y = element_text(color="black"))+
#   ggtitle("24 hour down MTX_DAR_DEG pairs (within 20kb of TSS) GO:MF enriched terms top 60")
### parsing similar terms:  
```
