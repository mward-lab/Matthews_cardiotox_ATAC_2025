...
EPI_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up EPI_DAR pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
EPI_DD_24_up_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("24 hour up EPI_DAR pairs (within 20kb of TSS) GO:MF enriched terms top 60")
```
...
EPI_DD_3_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down EPI_DAR_DEG_pairs 3 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
EPI_DD_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down EPI_DAR_DEG pairs (within 20kb of TSS) KEGG enriched terms top 60")
### parsing similar terms:  
```
...
DNR_DDall_3_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up DNR_DAR_DEG_pairs 3hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DDall_3_down_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  down DNR_DAR_DEG_pairs 3hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
DNR_DD_3_down_nomtable %>%
  ...
  guides(fill="none")+
  theme(axis.text.y = element_text(color="black"))+
  ggtitle("3 hour down DNR_DARDEG pairs (within 20kb of TSS) GO:BP enriched terms top 45")
...
MTX_DD_3_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in MTX_DAR_DEG_pairs 3 hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
...
MTX_DDall_3_up_nomtable %>%
  ...
  dplyr::filter(p_value < 0.05) %>% 
  mutate_at(.vars = 6, .funs = scientific_format()) %>%
  kable(.,caption = "Significant (p < 0.05 )terms found in  up MTX_DAR_DEG_pairs 3hours") %>%
  kable_paper("striped", full_width = FALSE) %>%
  kable_styling(
    full_width = FALSE,
    position = "left",
