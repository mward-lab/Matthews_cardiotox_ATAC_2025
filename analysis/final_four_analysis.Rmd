...
ggplot(., aes(x=AC_3h_lfc,y=RNA_3h_lfc))+
   geom_point()+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of shared H3K27ac peaks and RNA-NG  at 3 hours")+
...
ggplot(., aes(x=AC_24h_lfc,y=RNA_24h_lfc))+
   geom_point()+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of shared H3K27ac peaks and RNA-NG  at 24 hours")+
  xlab("H3K27ac peak LFC")+
   ylab("RNA LFC")
...
ggplot(., aes(x=med_3h_lfc,y=RNA_3h_lfc))+
   geom_point()+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of shared ATAC peaks and RNA-NG  at 3 hours")+
  xlab("ATAC peak LFC")+
   ylab("RNA LFC")
...
ggplot(., aes(x=med_24h_lfc,y=RNA_24h_lfc))+
   geom_point()+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of shared ATAC peaks and RNA-NG  at 24 hours")+
  xlab("ATAC peak LFC")+
   ylab("RNA LFC")
...
### Correlation between atac no- shared peak median LFC and RNA median LFC
```{r correlations 2kb}
...
### Correlations of ATAC peaks within 2kb and RNA 
...
ggplot(., aes(x=AC_3h_lfc,y=RNA_3h_lfc))+
   geom_point(col="cornflowerblue")+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of 2kb H3K27ac peaks and RNA-NG at 3 hours")+
  xlab("H3K27ac peak LFC")+
   ylab("RNA LFC")
...
ggplot(., aes(x=AC_24h_lfc,y=RNA_24h_lfc))+
   geom_point(col="cornflowerblue")+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of 2kb H3K27ac peaks and RNA-NG at 24 hours")+
  xlab("H3K27ac peak LFC")+
   ylab("RNA LFC")
```
...
ggplot(., aes(x=AC_3h_lfc,y=RNA_3h_lfc))+
   geom_point()+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of H3K27ac shared peaks (20kb)  and RNA-NG  at 3 hours")+
  xlab("H3K27ac peak LFC")+
   ylab("RNA LFC")
...
ggplot(., aes(x=AC_24h_lfc,y=RNA_24h_lfc))+
   geom_point()+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of H3K27ac shared peaks(20kb) and RNA-NG  at 24 hours")+
  xlab("H3K27ac peak LFC")+
   ylab("RNA LFC")
...
ggplot(., aes(x=med_3h_lfc,y=RNA_3h_lfc))+
   geom_point(col="cornflowerblue")+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of shared ATAC peaks (20kb) and RNA-NG  at 3 hours")+
  xlab("ATAC peak LFC")+
   ylab("RNA LFC")
...
ggplot(., aes(x=med_24h_lfc,y=RNA_24h_lfc))+
   geom_point(col="cornflowerblue")+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of shared ATAC peaks(20kb) and RNA-NG  at 24 hours")+
  xlab("ATAC peak LFC")+
   ylab("RNA LFC")
...
ggplot(., aes(x=AC_3h_lfc,y=RNA_3h_lfc))+
   geom_point(col="cornflowerblue")+
   sm_statCorr(corr_method = 'pearson')+
   ggtitle("Correlation of all H3k27ac peaks(2kb) and RNA-NG  at 3 hours")+
  xlab("H3K27ac peak LFC")+
   ylab("RNA LFC")
