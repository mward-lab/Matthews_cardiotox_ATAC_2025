...
# plot_list <- readRDS("data/Final_four_data/Plot_list_holder.RDS")
...
# plot_list <- list("a1"=a1,"a2"=a2,"b1"=b1,"b2"=b2,"c1"=c1,"c2"=c2,"d1"=d1,"d2"=d2)
# saveRDS(plot_list,"data/Final_four_data/Plot_list_holder.RDS")
...
fit <- euler(c("This study" = 155560 - 66927,        
               "Snyder study" = 218982 - 137976,        # Unique to B
               "This study&Snyder study" = min(66927, 137976)))
...
fullpeaks_joined_lfc %>% 
  ...
  xlab("ATAC peak LFC")+
   ylab("RNA LFC")
# ATAC3h_RNA3h_20kb_cor <- fullpeaks_joined_lfc %>% 
#   dplyr::filter(dist_to_NG>-20000 & dist_to_NG<20000)%>%
#    dplyr::summarise(cor_test = list(cor.test(AC_3h_lfc, RNA_3h_lfc, method = "pearson")))
