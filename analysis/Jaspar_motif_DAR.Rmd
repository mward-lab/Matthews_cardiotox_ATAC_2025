...
### DAR_DEG data up/down 24hour set
#### DOX
#### DOX 24_up hour
```{r loading DOX 24 DD up}
DOX_24_DD_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_DEG_24_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DOX_24_DD_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_DEG_24_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DOX_24_DD_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_DEG_24_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DOX_24_DD_up_sea_all <- rbind(DOX_24_DD_up_sea_disc, DOX_24_DD_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DOX_24_DD_up_xstreme data}
DOX_24_DD_up_combo <- DOX_24_DD_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DOX_24_DD_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="DOX_24_DD_up")

DOX_24_DD_up_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "DOX_24_DD_up DOX enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
DOX_24_DD_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DOX_24_DD_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
#### DOX 24_down hour
```{r loading DOX 24 DD down}
DOX_24_DD_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_DEG_24_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DOX_24_DD_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_DEG_24_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DOX_24_DD_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_DEG_24_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DOX_24_DD_down_sea_all <- rbind(DOX_24_DD_down_sea_disc, DOX_24_DD_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DOX_24_DD_down_xstreme data}
DOX_24_DD_down_combo <- DOX_24_DD_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DOX_24_DD_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="DOX_24_DD_down")

DOX_24_DD_down_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "DOX_24_DD_down DOX enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
DOX_24_DD_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DOX_24_DD_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
```
### DOX_DAR 24 20kb up data
```{r DOX_24_20kb_up output data loading}


DOX_24_20kb_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_24_20kb_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DOX_24_20kb_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_24_20kb_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DOX_24_20kb_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_24_20kb_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DOX_24_20kb_up_sea_all <- rbind(DOX_24_20kb_up_sea_disc, DOX_24_20kb_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DOX_24_20kb_up_xstreme data}
DOX_24_20kb_up_combo <- DOX_24_20kb_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DOX_24_20kb_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
DOX_24_20kb_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DOX_24_20kb_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
### DOX_DAR 24 20kb down data
```{r DOX_24_20kb_down output data loading}


DOX_24_20kb_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_24_20kb_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DOX_24_20kb_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_24_20kb_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DOX_24_20kb_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DOX_24_20kb_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DOX_24_20kb_down_sea_all <- rbind(DOX_24_20kb_down_sea_disc, DOX_24_20kb_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DOX_24_20kb_down_xstreme data}
DOX_24_20kb_down_combo <- DOX_24_20kb_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DOX_24_20kb_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
DOX_24_20kb_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DOX_24_20kb_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
#### EPI
##### EPI 24_up hour
```{r loading EPI 24 DD up}
EPI_24_DD_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_DEG_24_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
EPI_24_DD_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_DEG_24_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
EPI_24_DD_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_DEG_24_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
EPI_24_DD_up_sea_all <- rbind(EPI_24_DD_up_sea_disc, EPI_24_DD_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at EPI_3_DD_up_xstreme data}
EPI_24_DD_up_combo <- EPI_24_DD_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., EPI_24_DD_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="EPI_24_DD_up")

EPI_24_DD_up_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "EPI_24_DD_up EPI enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
EPI_24_DD_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("EPI_24_DD_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
##### EPI 24_down hour
```{r loading EPI 24 DD down}
EPI_24_DD_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_DEG_24_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
EPI_24_DD_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_DEG_24_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
EPI_24_DD_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_DEG_24_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
EPI_24_DD_down_sea_all <- rbind(EPI_24_DD_down_sea_disc, EPI_24_DD_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at EPI_24_DD_down_xstreme data}
EPI_24_DD_down_combo <- EPI_24_DD_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., EPI_24_DD_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="EPI_24_DD_down")

EPI_24_DD_down_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "EPI_24_DD_down EPI enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
EPI_24_DD_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("EPI_24_DD_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
```
### EPI_DAR 24 20kb up data
```{r EPI_24_20kb_up output data loading}


EPI_24_20kb_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_24_20kb_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
EPI_24_20kb_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_24_20kb_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
EPI_24_20kb_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_24_20kb_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
EPI_24_20kb_up_sea_all <- rbind(EPI_24_20kb_up_sea_disc, EPI_24_20kb_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at EPI_24_20kb_up_xstreme data}
EPI_24_20kb_up_combo <- EPI_24_20kb_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., EPI_24_20kb_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
EPI_24_20kb_up_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "Enriched motifs 200 bp in EPI24 20kb ") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
EPI_24_20kb_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("EPI_24_20kb_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
### EPI_DAR 24 20kb down data
```{r EPI_24_20kb_down output data loading}


EPI_24_20kb_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_24_20kb_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
EPI_24_20kb_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_24_20kb_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
EPI_24_20kb_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/EPI_24_20kb_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
EPI_24_20kb_down_sea_all <- rbind(EPI_24_20kb_down_sea_disc, EPI_24_20kb_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at EPI_24_20kb_down_xstreme data}
EPI_24_20kb_down_combo <- EPI_24_20kb_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., EPI_24_20kb_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
EPI_24_20kb_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("EPI_24_20kb_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
#### DNR
##### DNR 24_up hour
```{r loading DNR 24 DD up}
DNR_24_DD_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_DEG_24_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DNR_24_DD_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_DEG_24_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DNR_24_DD_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_DEG_24_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DNR_24_DD_up_sea_all <- rbind(DNR_24_DD_up_sea_disc, DNR_24_DD_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DNR_3_DD_up_xstreme data}
DNR_24_DD_up_combo <- DNR_24_DD_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DNR_24_DD_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="DNR_24_DD_up")

DNR_24_DD_up_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "DNR_24_DD_up DNR enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
DNR_24_DD_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DNR_24_DD_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
##### DNR 24_down hour
```{r loading DNR 24 DD down}
DNR_24_DD_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_DEG_24_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DNR_24_DD_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_DEG_24_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DNR_24_DD_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_DEG_24_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DNR_24_DD_down_sea_all <- rbind(DNR_24_DD_down_sea_disc, DNR_24_DD_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DNR_24_DD_down_xstreme data}
DNR_24_DD_down_combo <- DNR_24_DD_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DNR_24_DD_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="DNR_24_DD_down")

DNR_24_DD_down_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "DNR_24_DD_down DNR enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
DNR_24_DD_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DNR_24_DD_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
```
### DNR_DAR 24 20kb up data
```{r DNR_24_20kb_up output data loading}


DNR_24_20kb_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_24_20kb_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DNR_24_20kb_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_24_20kb_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DNR_24_20kb_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_24_20kb_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DNR_24_20kb_up_sea_all <- rbind(DNR_24_20kb_up_sea_disc, DNR_24_20kb_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DNR_24_20kb_up_xstreme data}
DNR_24_20kb_up_combo <- DNR_24_20kb_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DNR_24_20kb_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
DNR_24_20kb_up_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "Enriched motifs 200 bp in DNR24 20kb ") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
DNR_24_20kb_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DNR_24_20kb_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
### DNR_DAR 24 20kb down data
```{r DNR_24_20kb_down output data loading}


DNR_24_20kb_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_24_20kb_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
DNR_24_20kb_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_24_20kb_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
DNR_24_20kb_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/DNR_24_20kb_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
DNR_24_20kb_down_sea_all <- rbind(DNR_24_20kb_down_sea_disc, DNR_24_20kb_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at DNR_24_20kb_down_xstreme data}
DNR_24_20kb_down_combo <- DNR_24_20kb_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., DNR_24_20kb_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
DNR_24_20kb_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("DNR_24_20kb_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
#### MTX
##### MTX 24_up hour
```{r loading MTX 24 DD up}
MTX_24_DD_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_DEG_24_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
MTX_24_DD_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_DEG_24_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
MTX_24_DD_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_DEG_24_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
MTX_24_DD_up_sea_all <- rbind(MTX_24_DD_up_sea_disc, MTX_24_DD_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at MTX_3_DD_up_xstreme data}
MTX_24_DD_up_combo <- MTX_24_DD_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., MTX_24_DD_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="MTX_24_DD_up")

MTX_24_DD_up_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "MTX_24_DD_up MTX enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
MTX_24_DD_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("MTX_24_DD_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
##### MTX 24_down hour
```{r loading MTX 24 DD down}
MTX_24_DD_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_DEG_24_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
MTX_24_DD_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_DEG_24_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
MTX_24_DD_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_DEG_24_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
MTX_24_DD_down_sea_all <- rbind(MTX_24_DD_down_sea_disc, MTX_24_DD_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at MTX_24_DD_down_xstreme data}
MTX_24_DD_down_combo <- MTX_24_DD_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., MTX_24_DD_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
  ...
  dplyr::select(RANK,CLUSTER,SIM_MOTIF,ALT_ID, ID,CONSENSUS.x,motif_name,EVALUE.y,QVALUE,TP:ENR_RATIO) %>% 
  arrange(.,EVALUE.y) %>% 
  mutate(mrc_type="MTX_24_DD_down")

MTX_24_DD_down_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "MTX_24_DD_down MTX enriched motifs") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
MTX_24_DD_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("MTX_24_DD_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
### MTX_DAR 24 20kb up data
```{r MTX_24_20kb_up output data loading}


MTX_24_20kb_up_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_24_20kb_up_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
MTX_24_20kb_up_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_24_20kb_up_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
MTX_24_20kb_up_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_24_20kb_up_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
MTX_24_20kb_up_sea_all <- rbind(MTX_24_20kb_up_sea_disc, MTX_24_20kb_up_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at MTX_24_20kb_up_xstreme data}
MTX_24_20kb_up_combo <- MTX_24_20kb_up_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., MTX_24_20kb_up_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
MTX_24_20kb_up_combo %>% 
  dplyr::mutate_if(is.numeric, funs(as.character(signif(., 3)))) %>%
  kable(., caption = "Enriched motifs 200 bp in MTX24 20kb ") %>%
  kable_paper("striped", full_width = TRUE) %>%
  kable_styling(full_width = FALSE, font_size = 16) %>%
  scroll_box(height = "500px")
...
MTX_24_20kb_up_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("MTX_24_20kb_up_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
### MTX_DAR 24 20kb down data
```{r MTX_24_20kb_down output data loading}


MTX_24_20kb_down_sea_disc <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_24_20kb_down_xstreme/sea_disc_out/sea.tsv") %>% mutate(source="disc") %>% slice_head(n = length(.$ID)-3)
MTX_24_20kb_down_sea_known <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_24_20kb_down_xstreme/sea_out/sea.tsv") %>% mutate(source="known") %>% slice_head(n = length(.$ID)-3)
MTX_24_20kb_down_xstreme <- read.delim("C:/Users/renee/ATAC_folder/ATAC_meme_data/new_analysis/MTX_24_20kb_down_xstreme/xstreme.tsv") %>% slice_head(n = length(.$ID)-3)
MTX_24_20kb_down_sea_all <- rbind(MTX_24_20kb_down_sea_disc, MTX_24_20kb_down_sea_known) %>% 
  arrange(ID, desc(source == "known")) %>%  
  distinct(ID, .keep_all = TRUE)

```

```{r looking at MTX_24_20kb_down_xstreme data}
MTX_24_20kb_down_combo <- MTX_24_20kb_down_xstreme %>% 
  dplyr::select(SEED_MOTIF:EVALUE_ACC,SIM_MOTIF) %>% 
  left_join(., MTX_24_20kb_down_sea_all, by=c("ID"="ID","ALT_ID"="ALT_ID")) %>% 
  mutate(motif_name=case_when(
    str_detect(SIM_MOTIF, "\\(") ~ str_extract(SIM_MOTIF, "(?<=\\().+?(?=\\))"),
    str_detect(SIM_MOTIF, "^MA\\d+\\.\\d+") ~ ALT_ID,
    str_detect(SIM_MOTIF, "^\\d+-") ~ str_replace(SIM_MOTIF, "^\\d+-", ""),
...
MTX_24_20kb_down_combo %>% 
  ...
  theme_classic()+
  ylab("Enriched TF motif")+
  ggtitle(paste("MTX_24_20kb_down_combo response peaks(200bp)Enrichment ratio:",ER_rat))
...
### Looking at combo tables
```{r , fig.width=10}
 
DRUG_24_DD_df <- bind_rows(EPI_24_DD_up_combo,
          EPI_24_DD_down_combo,
          )
...
DRUG_24_DD_df %>% 
 ...
 # dplyr::filter(EVALUE.y<0.05) %>%  
  ...
  summarize(ID=paste(unique(ID), collapse = ";"),
    ...
    arrange(mrc_type,order_val) %>% 
  dplyr::select(mrc_type,CLUSTER, ALT_ID,order_val) %>% 
    DT::datatable(.)
