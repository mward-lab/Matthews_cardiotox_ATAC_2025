...
per_cov=0.5
median_24_lfc <- readRDS("data/Final_four_data/median_24_lfc.RDS") %>% ungroup()
median_3_lfc <- readRDS("data/Final_four_data/median_3_lfc.RDS") %>% ungroup()
...
```{r ESR-te, eval=FALSE, fig.height=5, include=FALSE}
...
```{r LRTE, eval=FALSE, fig.height=5, include=FALSE}
TE_LR_hyper_count <-
  Nine_group_TE %>%
...
#### NR
```{r NR-te, eval=FALSE, fig.height=6, include=FALSE}
TE_NR_count <-
  Nine_group_TE %>%
...
```{r LinesLTRand eight, eval=FALSE, fig.width=10, include=FALSE}
